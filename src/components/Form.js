...
const Form = () => {
  ...
  const handleChange = (e) => {
    const { name, value: changedValued } = e.target;
    switch (name) {
      case "name":
  ...
  return (
    <form className="login-form" onChange={handleChange} noValidate>
      <div className="input-container">
        <input
          name="name"
          className={`form-input ${isNameValid ? "not-valid" : ""}`}
          placeholder=" "
          type="text"
          required
        />
      ...
      <div className="input-container">
        <input
          name="email"
          className={`form-input ${isEmailValid ? "not-valid" : ""}`}
          placeholder=" "
          type="email"
          required
        />
      ...
      <div className="input-container select-div">
        <select
          name="user-type"
          className={`form-input select-wrapper ${
            isUserType ? "not-valid" : ""
          }`}
          type="text"
          onBlur={handleChange}
          required
        ...
        <label htmlFor="user-type" className="floating-label">
      ...
      <div className="btn-container">
        <button className="form-input" type="submit" disabled={!isFormValid}>
          Next
        </button>
      </div>
    </form>
